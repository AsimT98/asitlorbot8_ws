...
# pbounds = {f'd{i}': (0.01, 0.1) for i in range(15)}
pbounds = {
    'd0': (0.02, 0.09),    # Position x  
    'd1': (0.02, 0.09),    # Position y
    'd2': (0.02, 0.09),    # Position z
    'd3': (0.02, 0.09),  # Orientation roll
    'd4': (0.02, 0.09),  # Orientation pitch
    'd5': (0.02, 0.09),  # Orientation yaw
