...
#     process_noise_covariance_matrix = np.diag(process_noise_covariance_1d)
...
# # Extract process noise covariance values from the data
# process_noise_covariance_1d = data.iloc[0, 40:].values

# # Perform optimization
# res = objective_function(process_noise_covariance_1d)

# # Extract the optimized process noise covariance matrix
# optimized_process_noise_covariance_matrix = np.diag(process_noise_covariance_1d)
