...
hardware_interface::return_type asitlorbotInterface::read(const rclcpp::Time &,const rclcpp::Duration &)
{
...
PLUGINLIB_EXPORT_CLASS(asitlorbot_firmware::asitlorbotInterface, hardware_interface::SystemInterface)